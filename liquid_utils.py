"""Utilities for Liquid simulation and conceptual PSET handling."""
...
def build_swap_pset(
    ...
    """Construct a simulated swap PSET."""
...
def build_flashloan_pset(
    terms: amm_contract.FlashLoanTerms,
    swaps: Optional[Iterable[amm_contract.SwapQuote]] = None,
    expected_profit: Optional[Decimal] = None,
    notes: Optional[Dict[str, str]] = None,
) -> str:
    """Create a base64 payload for flash loan transaction."""
...
def sign_and_send_pset(
    ...
    """Process, finalize and broadcast a PSET or simulated payload."""
    ...
    # Fallback to RPC for real transactions
...
def fetch_pool_state() -> Dict[str, Decimal]:
    """Get current simulated pool reserves and price."""
